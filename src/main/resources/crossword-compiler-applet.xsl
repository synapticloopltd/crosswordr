...
<xsl:stylesheet version="1.0"
		...
		xmlns:cc="http://crossword.info/xml/crossword-compiler-applet"
...
<fo:page-sequence master-reference="A4-portrait">
	<fo:flow flow-name="xsl-region-body">
		...
		<xsl:variable name="width" select="/cc:crossword-compiler-applet/rp:rectangular-puzzle/rp:crossword/rp:grid/@width" />
		<xsl:variable name="height" select="/cc:crossword-compiler-applet/rp:rectangular-puzzle/rp:crossword/rp:grid/@height" />
		<xsl:for-each select="/cc:crossword-compiler-applet/rp:rectangular-puzzle/rp:crossword/rp:grid/rp:cell">
		...
		<fo:block font-size="8pt">
			<fo:table border-collapse="collapse" margin-top="12mm">
				<fo:table-body>
					<fo:table-row>
						<xsl:for-each select="/cc:crossword-compiler-applet/rp:rectangular-puzzle/rp:crossword/rp:clues">
